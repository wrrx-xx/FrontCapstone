                    ...
                    <div class="my-5">
                        ...
                        <div class="card mb-4 status-card">
                            <div class="card-body">
                                ...
                                @else
                                    <p class="text-danger">Your account is pending approval. You cannot create listings yet.
                                    </p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            @if ($maintenanceRequests->isNotEmpty())
                                <!-- Maintenance Alert -->
                                <div class="alert alert-warning d-flex align-items-center alert-dismissible fade show custom-alert"
                                    role="alert">
                            ...
                            @if ($payments->isNotEmpty())
                                <!-- Payment Alert -->
                                <div class="alert alert-success d-flex align-items-center alert-dismissible fade show mb-5 custom-alert"
                                    role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img"
                                        aria-label="Success:">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-xxl-3 mb-5 mb-xxl-0">
                                    <div
                                        class="bg-danger d-flex justify-content-between align-items-center p-3 rounded stats-card">
                                        <span class="display-5 text-white opacity-5"><i
                                ...
                                <div class="col-sm-6 col-xxl-3 mb-5 mb-xxl-0">
                                    <div
                                        class="bg-warning d-flex justify-content-between align-items-center p-3 rounded stats-card">
                                ...
                                <div class="col-sm-6 col-xxl-3 mb-5 mb-xxl-0">
                                    <div
                                        class="bg-info d-flex justify-content-between align-items-center p-3 rounded stats-card">
                                ...
                                <div class="col-sm-6 col-xxl-3 mb-5 mb-xxl-0">
                                    <div
                                        class="bg-orange d-flex justify-content-between align-items-center p-3 rounded stats-card">
                                        <span class="display-5 text-white opacity-5"><i
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-xl-5">
                                    <div class="bg-secondary-soft p-4 rounded activity-container">
                                        ...
                                        <div id="activity-list-container" style="max-height: 200px; overflow-y: auto;">
                                                ...
                                                @foreach ($maintenanceRequests as $request)
                                                    <li class="list-inline-item activity-item">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <p class="mb-0 text-dark">Maintenance request for
                                                                    {{ $request->listing->title }}</p>
                                                                <div class="small">
                                                                    {{ $request->created_at->format('d F Y') }}</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
                                                ...
                                                @foreach ($payments as $payment)
                                                    <li class="list-inline-item activity-item">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <p class="mb-0 text-dark">Payment received for
                                                                    {{ $payment->listing->title }}</p>
                                                                <div class="small">
                                                ...
                                                @foreach ($viewings as $viewing)
                                                    <li class="list-inline-item activity-item">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                <p class="mb-0 text-dark">Viewing request for
                                                                    {{ $viewing->listing->title }}</p>
                                                                <div class="small">
                                                                    {{ $viewing->created_at->format('d F Y') }}</div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endforeach
                                        ...
                                        <!-- button -->
                                        <div class="text-center">
                                            <button id="toggle-activity-list" type="button"
                                                class="btn btn-sm btn-primary-soft">View all</button>
                                        </div>

                                        @push('scripts')
                                            <script>
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    const toggleButton = document.getElementById('toggle-activity-list');
                                                    const activityListContainer = document.getElementById('activity-list-container');
                                                    let expanded = false;

                                                    toggleButton.addEventListener('click', function() {
                                                        if (expanded) {
                                                            activityListContainer.style.maxHeight = '200px';
                                                            activityListContainer.style.overflowY = 'auto';
                                                            toggleButton.textContent = 'View all';
                                                        } else {
                                                            activityListContainer.style.maxHeight = 'none';
                                                            activityListContainer.style.overflowY = 'visible';

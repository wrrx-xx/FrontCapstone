                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3">
                                                    @if($listing->photos->isNotEmpty())
                                                        <img class="rounded" src="{{ asset( $listing->photos->first()->photo_url) }}" alt="{{ $listing->title }}">
                                                    @else
                                    ...
                                    <div class="col-xxl-6 pt-2 pt-xxl-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 align-middle pt-2 pt-md-0">
                                                <div class="badge {{ $listing->availability == 'open' ? 'bg-success-soft text-success' : 'bg-danger-soft text-danger' }}">
                                                    <i class="fas fa-rupee-sign pe-1"></i>{{ ucfirst($listing->availability) }}
                                                </div>
                                            </div>
                                            <!-- Buttons -->
                                            <div class="col-md-4 align-middle pt-2 pt-md-0">

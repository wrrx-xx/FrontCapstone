                            ...
                            <div class="splide splide-thumb" data-splide='{"rewind":true,"fixedWidth":200,"fixedHeight":120,"isNavigation":true,"gap":10,"focus":"center","pagination":false,"cover":true,"lazyLoad":"sequential","breakpoints":{"600":{"fixedWidth":100,"fixedHeight":80}}}'>
                                ...
                                <div class="splide__arrows">
                                    ...
                                    <button class="splide__arrow splide__arrow--prev p-splide__arrow--prev bg-primary">
                                        ...
                                        <span class="spi-angle-left text-white"><i class="fas fa-fw fa-angle-left"></i></span>
                    
                                    </button>
                    
                                    <button class="splide__arrow splide__arrow--next p-splide__arrow--next bg-primary">
                    
                                        <span class="spi-angle-right text-white"><i class="fas fa-fw fa-angle-right"></i></span>
                                        ...
                                        <div class="col-sm-12 mb-0">
                                            <ul class="list-group list-group-borderless">
                                                <li class="list-group-item text-dark px-0 d-flex">
                                                    Address:<span class="text-body ms-2">{{ $listing->address }}</span </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <li class="list-group-item px-0">
                                            Property Size:<span class="text-body ms-2">{{ $listing->size }} ft<sup>2</sup></span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Basement:<span class="text-body ms-2">{{ $listing->amenities->basement ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Garage:<span class="text-body ms-2">{{ $listing->amenities->garage ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Roofing:<span class="text-body ms-2">{{ $listing->roofing ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Room:<span class="text-body ms-2">{{ $listing->amenities->rooms }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            View:<span class="text-body ms-2">{{ $listing->view }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <li class="list-group-item px-0">
                                            Customer ID:<span class="text-body ms-2">{{ $listing->owner_id }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Basement:<span class="text-body ms-2">{{ $listing->amenities->basement ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Garage Size:<span class="text-body ms-2">{{ $listing->amenities->garage_size }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Structure type:<span class="text-body ms-2">{{ $listing->structure_type }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Ownership:<span class="text-body ms-2">{{ $listing->ownership }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <ul class="list-group list-group-borderless">
                                        <li class="list-group-item px-0">
                                            Bathroom:<span class="text-body ms-2">{{ $listing->amenities->bathroom }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Bedroom:<span class="text-body ms-2">{{ $listing->amenities->bedroom }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Year Built:<span class="text-body ms-2">{{ $listing->year_built }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Available From:<span class="text-body ms-2">{{ $listing->available_from }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Roofing:<span class="text-body ms-2">{{ $listing->roofing ? 'Yes' : 'No' }}</span>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Floor No:<span class="text-body ms-2">{{ $listing->floor_no }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-12 border rounded p-4">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <ul class="list-group list-group-borderless">
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->kitchen ? 'check text-success' : 'times text-danger' }}"></i>
                                            Kitchen: {{ $listing->amenities->kitchen ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->laundry ? 'check text-success' : 'times text-danger' }}"></i>
                                            Laundry: {{ $listing->amenities->laundry ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->gym ? 'check text-success' : 'times text-danger' }}"></i>
                                            Gym: {{ $listing->amenities->gym ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->projector_room ? 'check text-success' : 'times text-danger' }}"></i>
                                            Projector Room: {{ $listing->amenities->projector_room ? 'Yes' : 'No' }}
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 col-md-4 mt-4 mt-sm-0">
                                    ...
                                    <ul class="list-group list-group-borderless">
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->back_yard ? 'check text-success' : 'times text-danger' }}"></i>
                                            Back yard: {{ $listing->amenities->back_yard ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->front_yard ? 'check text-success' : 'times text-danger' }}"></i>
                                            Front yard: {{ $listing->amenities->front_yard ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->attached_garage ? 'check text-success' : 'times text-danger' }}"></i>
                                            Attached garage: {{ $listing->amenities->attached_garage ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->pool ? 'check text-success' : 'times text-danger' }}"></i>
                                            Pool: {{ $listing->amenities->pool ? 'Yes' : 'No' }}
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 col-md-4 mt-4 mt-md-0">
                                    ...
                                    <ul class="list-group list-group-borderless">
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->elevator ? 'check text-success' : 'times text-danger' }}"></i>
                                            Elevator: {{ $listing->amenities->elevator ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->wifi ? 'check text-success' : 'times text-danger' }}"></i>
                                            Wifi: {{ $listing->amenities->wifi ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->school ? 'check ```blade
                                            text-success' : 'times text-danger' }}"></i>
                                            School: {{ $listing->amenities->school ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->transportation_hub ? 'check text-success' : 'times text-danger' }}"></i>
                                            Transportation hub: {{ $listing->amenities->transportation_hub ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->super_market ? 'check text-success' : 'times text-danger' }}"></i>
                                            Supermarket: {{ $listing->amenities->super_market ? 'Yes' : 'No' }}
                                        </li>
                                        <li class="list-group-item text-body">
                                            <i class="fas fa-fw fa-{{ $listing->amenities->clinic ? 'check text-success' : 'times text-danger' }}"></i>
                                            Clinic: {{ $listing->amenities->clinic ? 'Yes' : 'No' }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row mb-5 mb-lg-0">
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="bg-white p-4 mb-4 shadow-lg rounded">
                                    <h4 class="mb-4">Mortgage Calculator</h4>
                                    <div class="d-flex justify-content-between">
                                        <div>
                                        ...
                                        <div>
                                            <span class="text-dark">Your payment</span>
                                            <h5 class="text-success text-end">$2,354</h5>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <ul class="list-group list-group-borderless">
                                            <li class="list-group-item px-0 d-flex justify-content-between text-body">
                                                Total loan:<span class="text-dark">$785,222</span>
                                            </li>
                                            <li class="list-group-item px-0 d-flex justify-content-between text-body">
                                                Total interest paid:<span class="text-dark">$110,220</span>
                                            </li>
                                            <li class="list-group-item px-0 d-flex justify-content-between text-body">
                                                Payment:<span class="text-dark">Monthly</span>
                                            </li>
                                            <li class="list-group-item px-0 d-flex justify-content-between text-body">
                                                Mortgage payment:<span class="text-dark">$1500</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-12">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="formGroupExampleInput1" class="form-label">Total amount *</label>
                                                    <input type="text" class="form-control" id="formGroupExampleInput1" placeholder="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="formGroupExampleInput2" class="form-label">Down payment</label>
                                                    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="formGroupExampleInput3" class="form-label">Interest rate in % *</label>
                                                    <input type="text" class="form-control" id="formGroupExampleInput3" placeholder="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="formGroupExampleInput4" class="form-label">Amortization Period</label>
                                                    <input type="text" class="form-control" id="formGroupExampleInput4" placeholder="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="inputState" class="form-label">Payment period*</label>
                                                    <select id="inputState" class="form-select js-choice">

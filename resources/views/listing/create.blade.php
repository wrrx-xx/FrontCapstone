                ...
                <form action="{{ route('listing.store') }}" method="POST" enctype="multipart/form-data" id="listingForm">
                        ...
                        <div class="p-4 p-md-5 bg-white">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control p-0 overflow-hidden">
                                        <div class="btn-group w-100" role="group">
                                            <input type="radio" class="btn-check" name="availability" id="available" value="open" checked required>
                                            <label class="btn btn-outline-success py-2" for="available">Available Now</label>
                                            
                                            <input type="radio" class="btn-check" name="availability" id="unavailable" value="closed">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control p-0 overflow-hidden">
                                        <div class="btn-group w-100" role="group">
                                            <input type="radio" class="btn-check" name="reservation" id="reservable" value="open" checked required>
                                            <label class="btn btn-outline-success py-2" for="reservable">Accepting Reservations</label>
                                            
                                            <input type="radio" class="btn-check" name="reservation" id="not-reservable" value="closed">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text">₱</span>
                                        <input type="number" name="reservation_amount" id="reservation_amount" class="form-control" step="0.01" placeholder="0.00" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="maps" id="maps" class="form-control" placeholder="https://maps.google.com/..." required>
                                    </div>
                    ...
                    <div class="form-step" id="step4">
                        <div class="p-4 p-md-5 bg-white">
                            ...
                            <p class="text-muted mb-4">High-quality photos help your listing stand out! We recommend uploading at least 5 photos.</p>
                            ...
                            <div class="card bg-light">
                                <div class="card-body text-center p-5">
                                    <div class="upload-area" id="upload-area">
                                        ...
                                        <input type="file" name="photos[]" id="photos" class="form-control d-none" multiple required accept="image/*">

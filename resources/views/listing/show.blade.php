...
<main>
    <section class="pt-3 pt-md-4">
                        ...
                        <div class="col-lg-4 mt-4 mt-lg-0">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    @if($listing->tenant && auth()->id() === $listing->owner_id)
                                        <button type="button" class="btn btn-danger mt-3 ms-2" data-bs-toggle="modal" data-bs-target="#terminateTenantModal">
                                            Terminate Tenant
                                        </button>
                                    @endif
                                </div>
        ...
        <div class="modal fade" id="terminateTenantModal" tabindex="-1" aria-labelledby="terminateTenantModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="terminateTenantModalLabel">Terminate Tenant</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p>Are you sure you want to terminate the tenant's lease? This action cannot be undone.</p>
                        <form action="{{ route('listing.terminate-tenant', $listing->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="mb-3">

...
<!-- Mirrored from themes.webestica.com/realty/property-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Oct 2024 10:21:44 GMT -->
<head>
...
<header class="navbar-light navbar-sticky header-static">
	<div class="d-none navbar-top small">
		<div class="container">
			<div class="d-md-flex justify-content-between align-items-center my-2">
				<!-- Top bar left -->
				<ul class="nav text-dark-hover">
					<li class="nav-item">
						<a class="nav-link ps-0" href="#"><i class="fas fa-mobile-alt pe-2"></i>123-456-789</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#"><i class="far fa-envelope pe-2"></i>home.realty@.com</a>
					</li>
				</ul>
				<!-- Top bar right -->
				<ul class="nav text-dark-hover">
					<li class="nav-item">
						<a class="nav-link pe-0" href="#">Need help<i class="far fa-question-circle ps-2"></i></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll mx-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link navbar-primary-soft-hover dropdown-toggle active" href="#" id="homeMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="dashboard" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Dashboard</a>
						<div class="dropdown-menu pb-3 pb-lg-0 rounded" aria-labelledby="dashboard">
							<!-- Nav title -->
							...
							<div class="d-block d-sm-flex">
								<ul class="list-unstyled w-100 pe-0 pe-lg-5">
									...
									<li> <a class="dropdown-item" href="agent-favorite.html">My favorites</a></li>
									<li> <a class="dropdown-item" href="agent-review.html">Review</a></li>
								</ul>
								<ul class="list-unstyled w-100 pe-0 pe-lg-5">
									<li> <a class="dropdown-item" href="agent-profile.html">My profile</a></li>
									<li> <a class="dropdown-item" href="agent-package.html">My package</a></li>
									<li> <a class="dropdown-item" href="agent-message.html">Message</a></li>
									<li> <a class="dropdown-item" href="agency-agent-list.html">Agent list</a></li>
									<li> <a class="dropdown-item" href="add-new-agent.html">Add new agent</a></li>
								</ul>
							</div>
							<!-- Join us --> 
							<div class="row d-none d-lg-flex align-items-center justify-content-center text-center">
								<div class="col-md-11 rounded position-relative mt-2">
									<div class="card mb-4 overflow-hidden">
										<!-- Image -->
										<img class="card-img" src="assets/images/bg/bg-05.jpg" alt="Card image">
										<!-- Image overlay -->
										<div class="bg-overlay"></div>
										<div class="card-img-overlay bg-overlay-content"> 
											<!-- Category -->
											<div class="w-100 h-100 d-flex flex-column">
												<div class="my-auto">
													<!-- Title -->
													<h3 class="card-title text-white">Do you want to join our team?</h3>
													<!-- Button -->
													<a href="#" class="btn btn-primary mb-0">Join us</a>
												</div>
											</div>
										</div>
									</div>
...
<!-- =======================
Main Banner START -->
<section style="background:url(assets/images/bg/bg.jpg) no-repeat center center; background-size:cover; background-attachment: fixed;">
	<div class="container">
		<!-- Form START -->
		<form class="row">
				...
				<div class="shadow-lg p-3 bg-blur p-4 rounded-1">
					<div class="row g-3">
						<div class="col-lg-4 pt-3 pt-lg-0">
							<!-- Input -->
							<input type="text" class="form-control" id="formGroupExampleInput1" placeholder="Enter keyword">	
						</div>
					...
					<div class="row">
						...
						<div class="collapse" id="collapseExample">
							<div class="row g-3 mt-3">
								...
								<div class="col-sm-6 col-md-3 pb-2 pb-md-0">
									<!-- Input -->
							 		<input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Min Price">
								</div>
								<!-- Colleps item -->
								<div class="col-sm-6 col-md-3 pb-2 pb-md-0">
									<!-- Input -->
							 		<input type="text" class="form-control" id="formGroupExampleInput3" placeholder="Max Price">
								</div>
		...
		<div class="row">
			...
			<div class="col-lg-4 pt-5 pt-lg-0 order-2 order-lg-1">
				<div class="row mb-5 mb-lg-0">
								...
								<div class="row">
									<div class="col-12">
										...
										<form>
											...
											<!-- Min bathroom -->
											<select class="form-select mb-4 js-choice" aria-label="Default select example">
												<option value="">Min bathroom</option>
												<option>1</option>
												<option>2</option>
												<option>3</option>
											</select>
											...
											<!-- Price range START -->
											<h6 class="font-base mb-0"><i class="fas fa-dollar-sign me-2"></i>Price range</h6>
											<div class="position-relative my-3">
												<div class="noui-wrapper m-b-50 p-l-r">
													<div class="d-flex justify-content-between inputrange">
														<input type="text" class="text-body input-with-range-min">
														<input type="text" class="text-body input-with-range-max">
													</div>
													<div class="noui-slider-range m-b-20 mt-2" data-range-min='1000' data-range-max='100000' data-range-selected-min='40000' data-range-selected-max='70000'></div>
												</div>
											</div>
											<!-- Price range END -->
											...
											<div class="mt-5">
												...
												<div class="collapse" id="collapseExample1">
													<div class="card card-body p-0 mt-4">
														<!-- Amenities START -->
														<!-- Title -->
														<h5 class="font-base"><i class="fas fa-bars me-2"></i>Amenities</h5>
															<div class="row">
																<!-- Amenities group -->
																<div class="col-6">
																	<!-- Checkbox -->
														...
														<!-- Measurement START -->
														<h5 class="font-base mt-3"><i class="fas fa-drafting-compass me-2"></i>Measurement unit</h5>
															<!-- Radio -->
															<div class="form-check">
					...
					<div class="col-12 col-sm-6 col-lg-12">
						<!-- Latest view START -->
						<div class="bg-white shadow-lg rounded p-2 p-md-4 mb-4">
							<!-- Title -->
							<h4 class="mb-3">Latest property</h4>
							<!-- Slider START -->
							<div class="tiny-slider dots-creative arrow-round mb-4">
								<div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-dots="false" data-items="1" data-items-xs="1">
									<!-- Property START -->
									<div class="col-md-12">
														...
														<div class="w-100 h-100 d-flex flex-column">
															<div class="mb-auto">
																...
																<div class="d-flex justify-content-between">
																	...
																	<div>
																		<a href="#" class="badge bg-primary me-2"><i class="fas fa-user-friends pe-1"></i>Family</a>
																		<a href="#" class="badge bg-danger"><i class="fas fa-rupee-sign pe-1"></i>Sale</a>
																	</div>
																</div>
															</div>
															<!-- Title -->
															<h4 class="card-title"><a href="#" class="stretched-link text-light">157485 Camino Codorniz</a></h4>
														</div>
													</div>
											</div>
										</div>
						...
						<div class="bg-white p-4 shadow-lg rounded">
							...
							<div class="card mb-3">
								<div class="row g-3">
									...
									<!-- Info -->
									<div class="col-8">
										<h6><a href="#" class="stretched-link">Single House Near New York</a></h6>
							...
							<div class="card mb-3">
								<div class="row g-3">
									<!-- Image -->
									<div class="col-4">
										<img class="rounded" src="assets/images/property/grid-list/11.jpg" alt="">
									</div>
									<!-- Info -->
									<div class="col-8">
										<h6><a href="#" class="stretched-link">Single House Near New York</a></h6>
							...
							<div class="card mb-3">
								<div class="row g-3">
									<!-- Image -->
									<div class="col-4">
										<img class="rounded" src="assets/images/property/grid-list/01.jpg" alt="">
									</div>
									<!-- Info -->
									<div class="col-8">
										<h6><a href="#" class="stretched-link">Single House Near New York</a></h6>
				...
				<div class="row mt-5">
					...
					<div class="col-sm-6">
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img rounded" src="assets/images/property/grid-list/01.jpg" alt="Card image">
								<!-- Image overlay -->
					...
					<div class="col-sm-6">
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img rounded" src="assets/images/property/grid-list/02.jpg" alt="Card image">
								<!-- Image overlay -->
								<div class="card-img-overlay">
									<div class="text-end">
										<a href="#" class="badge bg-dark text-light me-2"><i class="fas fa-video pe-2"></i><span>4</span></a>
										<a href="#" class="badge bg-dark text-light"><i class="fas fa-camera pe-2"></i><span>1</span></a>
									</div>
								</div>	
							</div>	
							<!-- Card body START -->	
							<div class="card-body px-2 pt-3">
								...
								<ul class="nav nav-divider align-items-center text-uppercase small mt-3">
									...
									<li class="nav-item me-4">
										<i class="fas fa-user pe-1"></i> <span>8</span>
									</li>
									<li class="nav-item me-4">
										<i class="fas fa-square pe-1"></i> <span>3000<sup class="text-lowercase">m2</sup></span>
									</li>
								</ul>
								<!-- Price -->
								<div class="mt-3 d-flex justify-content-between align-items-center">
									<div>
										<h6 class="text-decoration-line-through mb-0 text-muted">$800,000</h6>
										<h3 class="text-success mb-0">$780,000</h3>
									</div>
									<!-- Button -->
									<a class="btn btn-dark btn-sm" href="#">View details</a>
								</div>
					...
					<div class="col-sm-6">
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img rounded" src="assets/images/property/grid-list/03.jpg" alt="Card image">
								<!-- Image overlay START-->
								<div class="card-img-overlay">
									<div class="d-flex justify-content-between">
							...
							<div class="card-body px-2 pt-3">
								...
								<div class="d-flex justify-content-between">
									<div>
										<a href="#" class="badge bg-primary-soft text-primary"><i class="fas fa-user-friends pe-1"></i>Family</a>
										<a href="#" class="badge bg-warning-soft text-warning"><i class="fas fa-rupee-sign pe-1"></i>For Sale</a>
									</div>
									<a href="#"><i class="far fa-heart fa-fw text-dark ms-auto"></i></a>
								</div>
								<!-- Title -->
								...
								<ul class="nav nav-divider align-items-center text-uppercase small mt-3">
									<li class="nav-item me-4">
										<i class="fas fa-bed pe-1"></i> <span>7</span>
									</li>
									<li class="nav-item me-4">
										<i class="fas fa-bath pe-1"></i> <span>5</span>
									</li>
									<li class="nav-item me-4">
										<i class="fas fa-user pe-1"></i> <span>12</span>
									</li>
									<li class="nav-item me-4">
										<i class="fas fa-square pe-1"></i> <span>4000<sup class="text-lowercase">m2</sup></span>
									</li>
								</ul>
								<!-- Price -->
								<div class="mt-3 d-flex justify-content-between align-items-center">
									<div>
										<h6 class="text-decoration-line-through mb-0 text-muted">$200,000</h6>
										<h3 class="text-success mb-0">$180,000</h3>
									</div>
									<!-- Button -->
									<a class="btn btn-dark btn-sm" href="#">View details</a>
								</div>
					...
					<div class="col-sm-6">
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img rounded" src="assets/images/property/grid-list/04.jpg" alt="Card image">
								<!-- Image overlay -->
								<div class="card-img-overlay">
									<div class="text-end">
										<a href="#" class="badge bg-dark text-light me-2"><i class="fas fa-video pe-2"></i><span>2</span></a>
							...
							<div class="card-body px-2 pt-3">
								...
								<!-- Price -->
								<div class="mt-3 d-flex justify-content-between align-items-center">
									<h3 class="text-success">$90,000</h3>
									<!-- Button -->
									<a class="btn btn-dark btn-sm" href="#">View details</a>
								</div>
							</div>
					...
					<div class="col-sm-6">	
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img rounded" src="assets/images/property/grid-list/05.jpg" alt="Card image">
								<!-- Image overlay -->
								<div class="card-img-overlay">
									<div class="text-end">
										<a href="#" class="badge bg-dark text-light me-2"><i class="fas fa-video pe-2"></i><span>2</span></a>
							...
							<div class="card-body px-2 pt-3">
								...
								<div class="d-flex justify-content-between">
									<div>
										<a href="#" class="badge bg-primary-soft text-primary"><i class="fas fa-user-friends pe-1"></i>Family</a>
										<a href="#" class="badge bg-warning-soft text-warning"><i class="fas fa-rupee-sign pe-1"></i>For Rale</a>
									</div>
									<a href="#"><i class="fas fa-heart fa-fw text-danger ms-auto"></i></a>
								</div>
								<!-- Title -->
					...
					<div class="col-sm-6">
						<div class="card mb-4">
							<div class="position-relative overflow-hidden">
								<!-- Image -->
								<img class="card-img" src="assets/images/property/grid-list/06.jpg" alt="Card image">
								<!-- Image overlay -->
								<div class="card-img-overlay">
									<div class="text-end">
										<a href="#" class="badge bg-dark text-light me-2"><i class="fas fa-video pe-2"></i><span>2</span></a>

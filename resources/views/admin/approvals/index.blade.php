                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @if($approval->owner_id_front_path)
                                                                ...
                                                                <img src="{{ asset($approval->owner_id_front_path) }}" alt="Owner ID Front" class="img-fluid" style="max-width: 100%; height: auto;">
                                                            @endif
                                                            @if($approval->owner_id_back_path)
                                                                <p><strong>Owner ID Back:</strong></p>
                                                                <img src="{{ asset($approval->owner_id_back_path) }}" alt="Owner ID Back" class="img-fluid" style="max-width: 100%; height: auto;">
                                                            @endif
                                                        </div>

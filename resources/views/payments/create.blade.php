...
@section('content')
                        ...
                        <form id="paymentForm" action="{{ route('payment.store') }}" method="POST"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="text" class="form-control" name="reservation_amount"
                                            id="reservation_amount" value="{{ $reservation->listing->reservation_amount }}"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control bg-light" value="{{ $advanceMonths }}"
                                        readonly>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control bg-light" name="total_amount"
                                            id="total_amount" value="{{ $totalAmount }}" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            @if ($advanceMonths > 0)
                                <div id="cash-advance-section" class="mb-4 p-3 bg-light rounded">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="cash_advance_amount" class="form-label fw-bold">Advance Payment
                                                Amount</label>
                                            <div class="input-group">
                                                <span class="input-group-text">P </span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input type="text" class="form-control" value="{{ $initialAmount }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="gcash-fields" class="mb-4 p-3 bg-light rounded" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" name="screenshot" id="screenshot"
                                        accept="image/*">
                                    <div class="form-text">Please upload a screenshot of your GCash payment confirmation
                                    </div>
                                </div>
                            </div>
    ...
    <a href="{{ route('owner.dashboard') }}" id="home-button" class="btn btn-primary">Go to Dashboard</a>
@elseif (auth()->user()->isAdmin())
    <a href="{{ route('admin.dashboard') }}" id="home-button" class="btn btn-primary">Go to Dashboard</a>
@else
    <a href="#" id="home-button" class="btn btn-secondary">No Dashboard Available</a>
@endif

                    <a href="#" id="downloadReceipt" class="btn btn-success" style="display: none;">Download
                        Receipt</a>
                </div>
            </div>
        </div>
            ...
            paymentMethodRadios.forEach(radio => {
                radio.addEventListener('change', function() {
                    if (this.value === 'gcash') {
                        ...
                        document.getElementById('reference_number').setAttribute('required',
                            'required');
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            if (!document.querySelector('.fas')) {
                                ...
                                document.getElementById('status-icon').innerHTML =
                                    '<div class="bg-success text-white rounded-circle p-3 d-inline-block"><span style="font-size: 2rem;">✓</span></div>';
                            }
                            ...
                            document.getElementById('amount-paid').textContent = 'P ' + (document
                                .getElementById('total_amount').value);
                            document.getElementById('payment-method').textContent = document
                                .querySelector('input[name="payment_method"]:checked').value ===
                                'cash' ? 'Cash' : 'GCash';
                            ...
                            if (!document.querySelector('.fas')) {
                                // Fallback if Font Awesome is not available
                                document.getElementById('status-icon').innerHTML =
                                    '<div class="bg-danger text-white rounded-circle p-3 d-inline-block"><span style="font-size: 2rem;">✗</span></div>';
                            }
                            document.getElementById('status-message').textContent = 'Payment Failed';
                            document.getElementById('status-details').textContent = data.message ||
